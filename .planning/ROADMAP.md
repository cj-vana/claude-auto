...
- [x] 10-02-PLAN.md -- Pipeline prompt builders, review verdict parser, pipeline orchestration module
- [x] 10-03-PLAN.md -- Orchestrator pipeline path, merge conflict handling, barrel exports
